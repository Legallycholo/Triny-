  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Lash Lift", item: "https://v0-triny.vercel.app/beauty-salon/lash-lift" },
      ],
    },
    {
      "@type": "LocalBusiness",
  ...
  return (
    <div data-seo-page className="min-h-screen pt-16">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-4">Lash Lift in Stone Mountain, GA</h1>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            A lash lift curls and lifts your natural lashes from the root so they look longer and more open — no extensions required. You lie back while we apply a gentle perm solution to set the shape; the result lasts weeks with minimal upkeep. Perfect for Stone Mountain clients who want definition and low maintenance without falsies or extensions.
          </p>
        </section>
        <section className="mb-10">
        ...
        <section className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-8 text-center">
          <h2 className="text-2xl font-semibold mb-2">Book Your Lash Lift in Stone Mountain</h2>
