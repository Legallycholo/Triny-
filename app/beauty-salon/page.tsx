      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
          ...
          <nav aria-label="Breadcrumb" className="text-sm" style={{ color: textMuted }}>
            <ol className="flex gap-2">
              ...
              <li>/</li>
              <li className="font-medium" style={{ color: textPrimary }}>Beauty Salon</li>
            </ol>
          </nav>
        </div>

        {/* Intro — CTA-style panel */}
        <section
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-4" style={{ color: textPrimary }}>
            Beauty Salon in Stone Mountain, GA
          </h1>
          <p className="text-lg leading-relaxed max-w-2xl" style={{ color: textMuted }}>
            ...
            for professional Beauty Salon services. With 21+ years of experience, Triny delivers
            exceptional results for every client — because you deserve to be consentida.
          </p>
        </section>

        {/* Services grid — card panels */}
        <section
          className="rounded-2xl border p-6 sm:p-8 mb-8 backdrop-blur-md"
          style={{ background: cardBg, borderColor: cardBorder }}
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { href: "/beauty-salon/eyebrow-tinting", label: "Eyebrow Tinting" },
              { href: "/beauty-salon/eyelash-extensions", label: "Eyelash Extensions" },
              { href: "/beauty-salon/eyebrow-threading", label: "Eyebrow Threading" },
              { href: "/beauty-salon/lash-lift", label: "Lash Lift" },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
        ...
        >
          ...
          <p className="text-sm mb-3" style={{ color: textMuted }}>Also see our hair services:</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/hairdresser" className="text-sm font-medium hover:underline" style={{ color: "rgb(212, 175, 55)" }}>Hairdresser</Link>
          </div>
        </section>

        {/* CTA block — prominent shape with background */}
        <section
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-semibold mb-2" style={{ color: textPrimary }}>
            Book Your Beauty Salon Appointment
          </h2>
