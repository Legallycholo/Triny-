  ...
  return (
    <div data-seo-page className="min-h-screen pt-16">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-4">Women&apos;s Haircut in Stone Mountain, GA</h1>
        ...
        <section className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-8 text-center">
          <h2 className="text-2xl font-semibold mb-2">Book Your Women&apos;s Haircut in Stone Mountain</h2>
