      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
          ...
          <nav aria-label="Breadcrumb" className="text-sm" style={{ color: textMuted }}>
            <ol className="flex gap-2">
              ...
              <li>/</li>
              <li className="font-medium" style={{ color: textPrimary }}>Hair Salon</li>
            </ol>
          </nav>
        </div>
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-4" style={{ color: textPrimary }}>
            Hair Salon in Stone Mountain, GA
          </h1>
          <p className="text-lg leading-relaxed max-w-2xl" style={{ color: textMuted }}>
            ...
            for professional Hair Salon services. With 21+ years of experience, Triny delivers
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { href: "/hair-salon/hair-colouring", label: "Hair Colouring" },
              { href: "/hair-salon/balayage", label: "Balayage" },
              { href: "/hair-salon/highlights", label: "Highlights" },
              { href: "/hair-salon/keratin-treatment", label: "Keratin Treatment" },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-semibold mb-2" style={{ color: textPrimary }}>
            Book Your Hair Salon Appointment
          </h2>
